					...
					<div class="card newsfeed-card mb-3 ">
						<div class="card-body">
							<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
								...
								<a class="nav-link" id="v-pills-social-tab" data-toggle="pill" href="#v-pills-socials" role="tab"> <i class="fas fa-rocket mr-2" aria-hidden="true"></i> Socials </a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="card newsfeed-card mb-3 ">
						<div class="card-body">
							<div class="tab-content" id="v-pills-tabContent">
								...
								<div class="tab-pane fade" id="v-pills-socials" role="tabpanel">
								    <?php $this->load->view('project-owner/dashboard/socials_form',['socials'=>$memberSocials]);?>
								</div>
