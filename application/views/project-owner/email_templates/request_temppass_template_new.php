					...
					<tr>
						<td valign="middle" class="hero bg_white" style="background-image: url(); background-color: #ffffff; background-size: cover; height: 400px;">
							...
							<table>
								<tr>
									<td>
										<div class="text" style="padding: 0 3em; text-align: center; color: #333333; ">
											<h1>Hello <?php echo !empty($name)?$name.',':'';?></h1>
											<p style="color: #555555; margin-bottom: 15px; font-size:18px">
												<?php echo $message?>
											</p>									
											<p style="margin-top: 30px;">
												<a href="<?php echo $link?>" class="btn btn-white-outline" style="background: #C69C6D; padding: 10px 15px;text-decoration: none;font-weight: bold;color: #fff;border-radius: 6px;">
													Click here to change temporary password
												</a>
											</p>
										</div>
									</td>
