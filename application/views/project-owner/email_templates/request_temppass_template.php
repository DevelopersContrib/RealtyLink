								...
								<td>
									<div class="text" style="padding: 0 3em; text-align: center; color: #ffffff;">
										...
										<p style="margin-top: 30px;">
											<a href="<?php echo $link?>" class="btn btn-white-outline" style="background: #666666; padding: 10px 15px;text-decoration: none;font-weight: bold;color: #fff;border-radius: 6px;">
