...
.section-top {	
	...
	rgba(255, 255, 255, 0.95) url('https://cdn.vnoc.com/mailchannel/businessman.jpg');	    
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						...
						<div class="bg-holder-box">
							<img class="img-fluid" src="https://cdn.vnoc.com/background/bg-service-chain-1.png">
							<div style="display:none;">
								<div class="bg-desc-1">
									Post your real estate or home services
								</div>
								<div class="bg-desc-2">
									We post it on the blockchain & create tokens for your project
								</div>
								<div class="bg-desc-3">
									Service provider sends proof
								</div>
								<div class="bg-desc-4">
									Service provider applies & finish the job
								</div>
								<div class="bg-desc-5">
									Project owner approves service & gives provider fractional ownership or cash
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container services-container">
				<div class="row justify-content-center">
					...
					<div  class="row" style="width: 100%;">
						<div class="col-md-12"  id="taskcontainer">
