	...
	<center style="width: 100%;">
		<div style="max-width: 600px; margin: 0 auto; background: #F0F1F6;" class="email-container">
			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
				...
				<!-- end tr -->
				<tr>
					<td valign="middle" class="hero bg_white" style="background-image: url(); background-color: #0177BF; background-size: cover; height: 400px;">
							...
							<tr>
								<td>
									<div class="text" style="padding: 0 3em; text-align: center; color: #ffffff;">
										...
										<p>
                                            Please click this <a href="<?=$link?>">link</a> to change your password.
                                        </p>						
										<!-- <p style="margin-top: 30px;">
											<a href="<?php //echo $link?>" class="btn btn-white-outline" style="background: #96B6CE; padding: 10px 15px;text-decoration: none;font-weight: bold;color: #fff;border-radius: 6px;">
			...
			<table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">				
				<tr>
					<td valign="middle" class="bg_black footer email-section" style="padding: 2.5em; background: #043A5C;">
						<table>
							<tr>
