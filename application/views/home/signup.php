...
.col-with-bg {
	background: linear-gradient(rgba(140, 98, 57, 0.85), rgba(83, 58, 34, 0.55)), rgba(140, 98, 57, 0.55) url('http://cdn.vnoc.com/mailchannel/businessman.jpg');
			...
			<div class="col-md-7 col-with-form">
				<div class="s-form-inner">
					...
					<div class="form-label-group mb-2">
						<div class="float-right"><small>Already a member? &nbsp;<a href="/login">Please Log In</a></small></div>
					...
					<div class="col-md-12 mx-auto">
						<div class="cwb">							
							<div class="text-center mb-2">
								<h1 class="h2 mb-3">Service Provider Sign Up</h1>
							</div>							
							<div class="text-center mb-2">								
							...
							<div class="text-center mt-5">
								...
								&nbsp;&nbsp;|&nbsp;&nbsp;
								<a href="project-owner/signup">Join as project owner</a>
								</small>
							</div>
						</div>
					</div>
