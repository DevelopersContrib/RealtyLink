...
class Settings extends CI_Controller {
    ...
    public function index(){
        if ($this->session->userdata('logged_in')){
            ...
            $this->load->view('project-owner/dashboard/settings',$data);
        }else{
	...
	private function sendEmail($data) {
   	...
   	public function uploadphoto(){
	    ...
	    $options = array( 'upload_dir' => './uploads/project-owner/settings/','upload_url' =>'/uploads/project-owner/settings/','accept_file_types'=>'/\.(gif|jpeg|jpg|png)$/i');
