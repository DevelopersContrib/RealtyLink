...
class CryptoAccount extends CI_Controller {
    ...
    public function index(){
        if ($this->session->userdata('logged_in')){
            ...
            $this->load->view('cryptoaccount/index',$data);
        }else{
            redirect("/");
            exit;
        }
...
task_contributions.notes, task_contributions.date_of_transaction,task_contributions.status,task_contributions.network,task_contributions.task_id ";
        ...
        if (isset($_GET['order'])){
            ...
            ->where('project_tasks.assigned_to',$this->session->userdata('userid'));
            ;
    ...
    public function generatewallet(){
        ...
        $email_message = $this->load->view('project-owner/email_templates/wallet_template',$data,TRUE);
