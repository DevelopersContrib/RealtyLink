...
class Paypal {
    ...
    */
    ...
    public function __construct($apiUsername = NULL, $apiPassword = NULL, $apiSignature = NULL, $live = true){
        ...
        $this->returnUrl = 'https://'.$_SERVER['SERVER_NAME'].$this->returnUrl;
        $this->cancelUrl = 'https://'.$_SERVER['SERVER_NAME'].$this->cancelUrl;
    }
