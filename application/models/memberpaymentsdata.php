<?php
class MemberPaymentsData extends CI_Model {
	private $table = "member_payments";
  ...
  function getbyattribute($key,$value,$key2=null, $value2=null){
   ...
   function getrows($conditions='',$order='', $limit=''){
	return  $this->db->query("SELECT * FROM $this->table where $conditions $order $limit ");
  }
